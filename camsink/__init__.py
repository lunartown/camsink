...
이 패키지는 webcam-blur 같은 상위 앱과 분리된 독립 패키지다.
"""
...
def _find_helper():
    ...
    candidates = [
        ...
        # 앱에 동봉해 배포하게 되면 이 경로에 들어간다.
        Path("/Applications/CamsinkApp.app/Contents/MacOS/camsink-feed"),
    ]
